...
VARIANTS={
    ...
    'LC':Config('LC',local_penalty=30,optical_ratio=1.5),
    'PC':Config('PC',selective=True,stop_budget=1,optical_ratio=1.5),
    'LPC':Config('LPC',local_penalty=30,selective=True,stop_budget=1,optical_ratio=1.5),
}
