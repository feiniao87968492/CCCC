...
from q4_local_policies import VARIANTS,make_runner,cover_context
...
def settings(suite):
    if suite=='primary':
        start,count=50000,200
        extras=50
    else:
        start,count=40000,30
        extras=10
...
def main():
    ...
    dependencies=[HERE/'q4_local_policies.py',Path(__file__),HERE/'design.md',HERE/'test_local.py',
