...
| 读取用户上传的 PDF | ✓ Python 环境 | 用 pypdf/pdfplumber 提取文本 |
...
```bash
pip install pypdf pdfplumber python-docx beautifulsoup4 requests
```
...
for page in PdfReader("/path/to/file.pdf").pages:
