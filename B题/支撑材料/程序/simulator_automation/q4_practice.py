...
def main() -> None:
    ...
    parser.add_argument("--cover-mode", default="TRI25", choices=["SQUARE81", "HEX37", "TRI25"],
                        help="certified discovery cover; default TRI25")
    parser.add_argument("--route-mode", default="ROUTE_ADAPTIVE_V4",
                        choices=["OLD_HEX37", "ROUTE_INSERT_V1", "ROUTE_INSERT_V2", "ROUTE_INSERT_V3", "ROUTE_ADAPTIVE_V4"],
                        help="online routing policy; default ROUTE_ADAPTIVE_V4")
